...
describe('Knex extensions', function () {
  describe('Filter', function () {
    it('should produce correct SQL for a single simple column filter', function () {
      const filterQuery = {
    ...
    it('should produce correct SQL if no filter is used', function () {
      const filterQuery = {};
      const filters = {
        column1: {},
        column2: {},
    ...
    it('should produce correct SQL if no filter is provided', function () {
      const filterQuery = {
        column1: 'filter query 1',
    ...
    it('should produce correct SQL for multiple simple column filters', function () {
      const filterQuery = {
        column1: 'filter query 1',
        column3: 'filter query 2'
      };
    ...
    it('should produce correct SQL for multiple filters with custom operators', function () {
      const filterQuery = {
        column1: 'filter query 1',
    ...
    it('should produce correct SQL for multiple named filters with custom operators', function () {
      const filterQuery = {
